    ...
    <section className="bg-white rounded-2xl border border-gray-200 p-6">
      ...
      <div className="grid sm:grid-cols-4 gap-2 mb-5 text-xs">
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg px-2.5 py-2">
          ...
          <p className="text-mute text-[11px]"><strong>Pending</strong><br/><span className="text-mute/80">needs {BRAND.name} lease</span></p>
        </div>
      </div>
    ...
    <section className="bg-white rounded-2xl border border-gray-200 p-6">
      ...
      <div className="bg-brand-50/60 border border-brand-200 rounded-xl p-4 text-sm text-ink mb-5">
        ...
        <ul className="list-disc pl-5 mt-2 text-xs text-mute leading-relaxed space-y-1">
          ...
          <li>Every matched tenant gets a "your landlord moved to {BRAND.name}" email</li>
          ...
          {statusCounts.pending > 0 && <li><strong>{statusCounts.pending} Pending</strong> — no signed PDF — generate a {BRAND.name} lease before activating</li>}
  ...
  return (
    <section className="bg-white rounded-2xl border border-gray-200 p-6 text-center">
      ...
      <p className="text-sm text-mute mt-2 max-w-md mx-auto">
        Tenants are getting their migration emails now. Leases with existing signed PDFs are already <strong>Active</strong>; the rest stay <strong>Pending</strong> until you generate a {BRAND.name} agreement.
      </p>
