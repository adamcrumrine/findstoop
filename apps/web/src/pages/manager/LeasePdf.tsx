...
//
// Renders the lease in a legal-document style — serif typography, FindStoop
...
export default function LeasePdf() {
  ...
  // FindStoop subscription is active. Admin bypasses both gates for support.
  ...
  if (!isAdmin && (!lease.signed_at || billingActive === false)) {
    ...
    const reason = !lease.signed_at
      ...
      : 'The finalized PDF will be available once the landlord completes FindStoop billing setup.'
    return (
