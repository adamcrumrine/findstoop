...
export default function Terms() {
  useSeo({
    ...
    description: 'The agreement between FindStoop and the landlords, tenants, and applicants who use the platform.',
    path: '/terms',
  })
    ...
    <div className="max-w-2xl mx-auto py-10 px-5">
      ...
      <section className="mt-8 space-y-6 text-sm leading-relaxed text-ink">
        ...
        <Sec title="2. Eligibility + geographic availability">
          ...
          <p className="mt-2">
            <strong>FindStoop is currently paused for new account signups and property listings in New York, California,
        ...
        <Sec title="6. Rent collection (tenants paying landlords)">
          ...
          <p className="mt-2">
            FindStoop is not a party to any rental agreement between landlord and tenant. We act as the technology facilitator
        ...
        <Sec title="9. Your content">
          You keep ownership of the content you upload (photos, applications, documents). By uploading, you grant FindStoop
        ...
        <Sec title="14. Indemnification">
          You agree to indemnify and hold harmless FindStoop and its officers, employees, and contractors from any claim,
        ...
        <Sec title="15. Dispute resolution + binding arbitration">
          ...
          <p className="mt-2">
            <strong>Class action waiver.</strong> You and FindStoop agree to bring disputes only in individual capacity, and
