...
export default function RenterResources() {
  ...
  const tools: { icon: LucideIcon; title: string; desc: string; to: string; external?: boolean }[] = [
    ...
    { icon: GitCompareArrows, title: 'Compare move-in vs move-out', desc: 'See your move-in photos next to your move-out photos to spot what really changed.', to: leaseId ? `/tenant/lease/${leaseId}/inspection-compare` : '#' },
